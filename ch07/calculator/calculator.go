...
And also make sure that the example works file even though math function name entered by the user is lower case of 
name registered by the calculator. 
...
import (
	...
	"fmt"
	"math"
	mathFunction "github.com/Property-Finder-Patika/week-4-homework-1-berketoraman/ch07/mathFunction"
	"os"
	"strings"
)
